...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tsChannel = new ThingSpeakChannel(276453,"YMOEOC70Y5CKSGRQ");
        ...
        calendar.add(Calendar.MINUTE, -5000);
        ...
        tsChart = new ThingSpeakLineChart(276453, 1);
        // Get 200 entries at maximum
        tsChart.setNumberOfEntries(2000);
        // Set value axis labels on 10-unit interval
        tsChart.setValueAxisLabelInterval(100);
