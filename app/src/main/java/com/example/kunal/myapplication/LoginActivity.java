...
public class LoginActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        channel = (EditText) findViewById(R.id.input_id);
    ...
    private void attemptLogin() {
            ...
            if(channelID.equals("276453") || channelID.equals("276453")  || channelID.equals("276453") ){
                ...
                Toast.makeText(this,"Enter a valid Channel ID !!",Toast.LENGTH_LONG).show();
            }
